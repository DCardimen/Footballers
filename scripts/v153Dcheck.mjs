...
// ============================== 2. the medal box ==============================
{
  ...
  ok(b && b.prevIsHero && b.nextIsCard && b.top > b.logoBottom && b.top >= b.heroBottom - 1 && b.top < b.heroBottom + 24 && b.left <= b.logoLeft + 16, 'right below the RUNNING IT BACK logo, before the player card, never over the hero (the kit is measured there)', b && { top: b.top, logoBottom: b.logoBottom, heroBottom: b.heroBottom, left: b.left, logoLeft: b.logoLeft })
