...
const p = await (await b.newContext({ viewport: { width: 1080, height: 900 }, deviceScaleFactor: 2 })).newPage()
...
await p.screenshot({ path: process.env.OUT || 'pal.png', clip: { x: 0, y: 60, width: 1080, height: 660 } })
await b.close()
