// The v149 C name map: [old, new, what it is, evidence]. Batches are applied in order.
// "module:X" = the original export name kept in the bundle's frozen module namespace objects
// (`jo` = the v11 module, `Do` = the v12 life module); "audit:X" = the key window.__GRIDIRON_AUDIT__
// (or another window export) already gives it; otherwise the definition is quoted.
export const BATCHES = [
  ...
  ['modules', [
    // the v11 module namespace (`jo`, exported to the audit as V11)
    ...
    // the v12 life module (`Do`, exported to the audit as V12)
  ...
  ['exports', [
    // named after the key window.__GRIDIRON_AUDIT__ or a window.* export already gives them
  ...
  ['tail2', [
    // the v11 / v12 Object.assign(window, {...}) export blocks name these
