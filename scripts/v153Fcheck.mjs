...
// ============================== 4. the numbers ==============================
{
  ...
  ok(n.part === 'Chaos ×1.80 · +80% XP' && Math.abs(n.gain / n.gain0 - 1.8) < 0.01, 'the Legacy XP card lists the Chaos part with its bonus, and the gain carries it', { part: n.part, gain: n.gain, gain0: n.gain0 })
  ...
  ok(d.pp.some((t) => /×13\.2\s*PP Gains/i.test(t)), 'and the PP multiplier', d.pp)
  ...
  ok(/CHAOS BONUS ×1\.80 LEGACY XP/.test(tc), 'the trophy case quotes the Chaos bonus', tc)
