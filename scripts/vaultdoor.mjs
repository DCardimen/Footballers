...
await page.evaluate(() => { const o = window.__GRIDIRON_AUDIT__.getState(); o.pp = 240000; o.prestige = 40; window.__V156A && window.__V156A.seed(200) /* v156 A: the medals open the tree */; o.view = 'shop'; window.render() })
