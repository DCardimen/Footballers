...
ok(/function shellPreV146\(/.test(src) && /function shellPostV146\(/.test(src) && /const _qV146\s*=\s*render;\s*render\s*=\s*function/.test(src), 'the shell hook is a hoisted declaration wrapped round the last q()')
