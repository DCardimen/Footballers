...
// ============================== 1. OFF: the file is present and changes nothing ==============================
{
  ...
  ok(sa.setSpeed === sb.setSpeed && /^function ml\(/.test(sa.setSpeed), 'OFF: window.setSpeed is the game\'s own ml(), exactly as with the file blocked', sa.setSpeed.slice(0, 40))
