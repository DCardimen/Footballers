  ...
  var BASE = {
    ...
    products: [
      ...
      { id: "rib.pro", kind: "nonconsumable", tier: "pro", title: "Pro Career", price: "$8.99",
        ...
        blurb: ["Everything in Ad Free", "4× play speed, permanently", "Advanced sim — +3 season sims every career on top of your medals'", "Advanced filters — sort and filter Stats, Leaders and the Hall of Fame", "3 extra save slots (when slots ship)"] },
