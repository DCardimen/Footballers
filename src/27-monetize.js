 ...
 * first finished career, 3× on reaching the UFF, 4× with 3× while this module is OFF, season skips a day from lifetime
...
(function () {
  ...
  css.textContent = [
    ...
    ".mz151-tabs{display:flex;gap:6px;overflow-x:auto;padding-bottom:2px}",
    ...
    ".mz151-pack .mz149-btn{font-size:11px;padding:8px 6px}",
