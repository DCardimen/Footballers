...
Every suite in `scripts/checks.json` (82 suites, 144 checks; `fast` and `full` are
...
| `cosmetics` | v151 B — cosmetics and the profile: RIB_COSMETICS, the kit / helmet / celebration / stadium / vault hooks, the Locker's STYLE tab, the PROFILE view, the Team Creator's gated crests and colours (src/28-cosmetics.js) | `v156Ccheck`, `v151Bcheck`, `v153Gcheck`, `v151Ccheck`, `kitsidecheck`, `emblemcheck`, `vaultcheck`, `bootviewcheck`, `menu-integration-check`, `v146Echeck`, `layoutcheck`, `walk` | `v151 B`, `RIB_COSMETICS`, `v153 G`, `v156 C`, `src/28-cosmetics.js`, `docs/COSMETICS.md` |  |
