...
Every suite in `scripts/checks.json` (82 suites, 146 checks; `fast` and `full` are
...
| `cosmetics` | v151 B — cosmetics and the profile: RIB_COSMETICS, the kit / helmet / celebration / stadium / vault hooks, the Locker's STYLE tab, the PROFILE view, the Team Creator's gated crests and colours (src/28-cosmetics.js) | `v157Acheck`, `v156Ccheck`, `v151Bcheck`, `v153Gcheck`, `v151Ccheck`, `kitsidecheck`, `emblemcheck`, `vaultcheck`, `bootviewcheck`, `menu-integration-check`, `v146Echeck`, `layoutcheck`, `walk`, `v157Bcheck` | `v151 B`, `RIB_COSMETICS`, `v153 G`, `v156 C`, `v157 A`, `v157 B`, `src/28-cosmetics.js`, `docs/COSMETICS.md` |  |
...
| `legacy` | v152 A — the Legacy Rank: the 500 medals (src/31-legacy.js, the RIB_LEGACY_MEDALS_V152 block, scripts/build-legacy-medals.py), the ledger in 07 (legacy*V152), the pour and the medal swap, milestones, Rank 500, the profile's trophy case and collection book, the rank chips | `v152Acheck`, `v151Ccheck`, `v151Bcheck`, `bootviewcheck`, `layoutcheck`, `menu-integration-check`, `v153Fcheck`, `v153Echeck`, `v156Acheck` | `v152 A`, `RIB_LEGACY`, `v153 F`, `src/31-legacy.js`, `public/legacy/**`, `scripts/build-legacy-medals.py`, `art/legacy/**` |  |
