...
Every suite in `scripts/checks.json` (80 suites, 141 checks; `fast` and `full` are
...
| `career-uff` | v147 A — retiring above college, sim the rest at 7+, stale offers, auto-answered story decisions | `v154Acheck`, `v147Acheck`, `v146Bcheck`, `rivalcheck`, `v90check`, `v85check`, `v136check`, `declarecheck`, `v88check`, `bootviewcheck`, `v146Echeck`, `walk` | `v147 A`, `v154 A` |  |
