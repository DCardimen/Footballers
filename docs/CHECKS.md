...
Every suite in `scripts/checks.json` (81 suites, 142 checks; `fast` and `full` are
...
| `seasons` | v151 C — competitive seasons, the Career Pass, the career leaderboards, the trophy case (src/29-seasons.js, src/20-leaderboards.js v151 C) | `v151Ccheck`, `v153Gcheck`, `lbcheck`, `dailycheck`, `bootviewcheck`, `menu-integration-check`, `v146Echeck`, `v150Ccheck`, `layoutcheck`, `walk` | `v151 C`, `RIB_SEASONS`, `src/29-seasons.js`, `src/20-leaderboards.js`, `docs/SEASONS.md` |  |
| `cosmetics` | v151 B — cosmetics and the profile: RIB_COSMETICS, the kit / helmet / celebration / stadium / vault hooks, the Locker's STYLE tab, the PROFILE view, the Team Creator's gated crests and colours (src/28-cosmetics.js) | `v151Bcheck`, `v153Gcheck`, `v151Ccheck`, `kitsidecheck`, `emblemcheck`, `vaultcheck`, `bootviewcheck`, `menu-integration-check`, `v146Echeck`, `layoutcheck`, `walk` | `v151 B`, `RIB_COSMETICS`, `v153 G`, `src/28-cosmetics.js`, `docs/COSMETICS.md` |  |
