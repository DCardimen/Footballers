...
Every suite in `scripts/checks.json` (72 suites, 124 checks; `fast` and `full` are
...
|---|---|---|---|---|
| `smoke` | fast and broad — boot to menu, the shell, a career screen or five, the pregame, the live field, the engine; every check here is under ~3 min and passes on main. Run before every commit. | `namecheck`, `walk`, `shot`, `menu-integration-check`, `honorcheck`, `v85check`, `v146Echeck`, `v112Dcheck`, `v144check`, `simcheck`, `v110check`, `v146Bcheck`, `v147Ccheck`, `scrollcheck`, `freshcheck`, `v142check`, `agecheck`, `traincheck`, `layoutcheck`, `anchorcheck` | — |  |
...
| `contact` | v146 A — who is on him when he goes down, the fall together, the taken sack | `v146Acheck`, `v143check`, `scoreneutralcheck`, `tacklecheck`, `jukecheck`, `creditcheck`, `v103check`, `v109C1check`, `v112Fcheck`, `renderpathcheck`, `v86check`, `v110check` | `v146 A` |  |
...
| `boot` | v140 — the top level of the career block, the boot, functions a rendered screen calls by bare name | `bootviewcheck`, `splashcheck`, `walk`, `vaultcheck`, `menu-integration-check`, `shot` | `v140`, `safeBootV140` |  |
...
| `tackle` | v143 + contact physics — approach angle, windup, low/mid/high, what each aim costs | `v143check`, `scoreneutralcheck`, `tacklecheck`, `jukecheck`, `creditcheck`, `v103check`, `v109C1check`, `v112Fcheck`, `renderpathcheck`, `v86check` | `v143`, `hitGeoV109` | first: `scoreneutralcheck` over several seeds, against the OFF spread (the aim roll changes sample paths) |
...
| `names` | v123 — school / college / club names and crests | `namecheck`, `emblemcheck`, `menu-integration-check`, `walk` | `v123` |  |
...
| `declare` | the declare / career-end screens | `declarecheck` | `declare` |  |
...
| `monetize` | v149 E — the monetization module (switched off by default) | `v149Echeck`, `bootviewcheck`, `walk`, `menu-integration-check`, `layoutcheck`, `honorcheck`, `vaultcheck` | `v149 E`, `RIB_MONETIZE`, `src/27-monetize.js` |  |
| `pwa` | v149 D — the PWA, service worker, platform layer and Capacitor config | `v149Dcheck`, `bootviewcheck`, `freshcheck`, `splashcheck`, `walk`, `menu-integration-check`, `layoutcheck` | `v149 D`, `src/26-platform.js`, `pwa/sw.js`, `scripts/lib/pwa.mjs`, `vite.config.js`, `scripts/assemble-pages.mjs`, `capacitor.config.json` |  |
